...
data object MessagesFa : Messages {
    ...
    override val error = "خطایی در برنامه رخ داد. خطا در زیر نمایش داده شده است.\nبرای جزئیات بیشتر، وقایع (لاگ) برنامه را مشاهده کنید."
    override val openLogFolder = "باز کردن پوشه وقایع (لاگ) برنامه"
    ...
    override val no = "خیر"
    override val qualityNotApplicableToRawFormat = "اصلی (کیفیت خروجی خام را نمی‌توان تغییر داد)"
    ...
    override val openSaveFolder = "باز کردن پوشه ذخیره"
    ...
    override val btnLblOpenAppLogFolder = "باز کردن پوشه وقایع (لاگ) برنامه"
    ...
    override val txtLblInputAlbumArtNotSupported = "فرمت ورودی از آلبوم‌آرت پشتیبانی نمی‌کند"
    ...
    override val txtLblErrorClipFileNotSet = "$btnLblSelectSaveFolder مشخص نشده است"
